...
namespace App\Http\Responsables\Informes\Servicios;

use Illuminate\Contracts\Support\Responsable;

use App\Modelos\DBServicios\ViewServiciosDiariosXMovil;
...
class Listar implements Responsable
{
    ...
    public function toResponse($request)
    {
        ...
        $listado = ViewServiciosDiariosXMovil::_listar($docu_empre, $codi_circu, $desde, $hasta);
        //$listado = ViewServiciosDiariosXMovil::all();
        if($listado->count() > 0){
